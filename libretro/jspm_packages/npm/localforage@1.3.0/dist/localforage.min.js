      ...
      b.__esModule = !0, function() {
        ...
        function e() {
          for (var a = 1; a < arguments.length; a++) {
            ...
            if (b)
              for (var c in b)
                b.hasOwnProperty(c) && (m(b[c]) ? arguments[0][c] = b[c].slice() : arguments[0][c] = b[c]);
          }
          return arguments[0];
        }
        function f(a) {
          for (var b in h)
            if (h.hasOwnProperty(b) && h[b] === a)
              return !0;
          return !1;
        }
        var g = {},
            ...
            l = function(a) {
              var b = b || a.indexedDB || a.webkitIndexedDB || a.mozIndexedDB || a.OIndexedDB || a.msIndexedDB,
                  c = {};
              return c[h.WEBSQL] = !!a.openDatabase, c[h.INDEXEDDB] = !!function() {
            ...
            n = function() {
              function b(a) {
                d(this, b), this.INDEXEDDB = h.INDEXEDDB, this.LOCALSTORAGE = h.LOCALSTORAGE, this.WEBSQL = h.WEBSQL, this._defaultConfig = e({}, k), this._config = e({}, this._defaultConfig, a), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver);
              }
              return b.prototype.config = function(a) {
              ...
              }, b.prototype.defineDriver = function(a, b, c) {
                var d = new Promise(function(b, c) {
                  try {
                    ...
                    if (f(a._driver))
                      return void c(h);
                    for (var i = j.concat("_initStorage"),
                        k = 0; k < i.length; k++) {
                      var m = i[k];
              ...
              }, b.prototype.getDriver = function(a, b, d) {
                var e = this,
                    h = function() {
                      if (f(a))
                        switch (a) {
                        ...
                        return Promise.resolve(g[a]);
                      return Promise.reject(new Error("Driver not found."));
                    }();
                return h.then(b, d), h;
              }, b.prototype.getSerializer = function(a) {
                ...
                return c.then(a, a), c;
              }, b.prototype.setDriver = function(a, b, c) {
                function d() {
                ...
                return !!l[a];
              }, b.prototype._extend = function(a) {
                e(this, a);
              }, b.prototype._getSupportedDrivers = function(a) {
                for (var b = [],
                    c = 0,
                    d = a.length; d > c; c++) {
                  var e = a[c];
                ...
                for (var b = 0; b < j.length; b++)
                  a(this, j[b]);
              }, b.prototype.createInstance = function(a) {
                return new b(a);
              }, b;
            }(),
            o = new n;
        b["default"] = o;
      }.call("undefined" != typeof window ? window : self), a.exports = b["default"];
    }, function(a, b) {
      "use strict";
      b.__esModule = !0, function() {
        function a(a, b) {
          ...
          try {
            ...
            if ("TypeError" !== c.name)
              throw c;
            for (var d = x.BlobBuilder || x.MSBlobBuilder || x.MozBlobBuilder || x.WebKitBlobBuilder,
                e = new d,
                f = 0; f < a.length; f += 1)
              e.append(a[f]);
        ...
        function e(b) {
          return new Promise(function(c, e) {
            var f = a([""], {type: "image/png"}),
                g = b.transaction([B], "readwrite");
            g.objectStore(B).put(f, "key"), g.oncomplete = function() {
              var a = b.transaction([B], "readwrite"),
                  f = a.objectStore(B).get("key");
        ...
        function f(a) {
          return "boolean" == typeof z ? Promise.resolve(z) : e(a).then(function(a) {
            return z = a;
          });
        }
        function g(a) {
        ...
        function j(a) {
          ...
          f || (f = {
            forages: [],
            db: null
          }, A[d.name] = f), f.forages.push(this);
          for (var g = [],
              h = 0; h < f.forages.length; h++) {
            var i = f.forages[h];
            i !== this && g.push(i.ready()["catch"](b));
          }
          var j = f.forages.slice(0);
          return Promise.all(g).then(function() {
            return d.db = f.db, k(d);
          }).then(function(a) {
            return d.db = a, n(d, c._defaultConfig.version) ? l(d) : a;
          }).then(function(a) {
        ...
        function m(a, b) {
          return new Promise(function(c, d) {
            ...
            var e = [a.name];
            b && e.push(a.version);
            var f = y.open.apply(y, e);
            b && (f.onupgradeneeded = function(b) {
              var c = f.result;
              try {
                c.createObjectStore(a.storeName), b.oldVersion <= 1 && c.createObjectStore(B);
              } catch (d) {
                if ("ConstraintError" !== d.name)
                  throw d;
                x.console.warn('The database "' + a.name + '" has been upgraded from version ' + b.oldVersion + " to version " + b.newVersion + ', but the storage "' + a.storeName + '" already exists.');
              }
            }), f.onerror = function() {
              d(f.error);
        ...
        function n(a, b) {
          ...
          if (d && (a.version !== b && x.console.warn('The database "' + a.name + "\" can't be downgraded from version " + a.db.version + " to version " + a.version + "."), a.version = a.db.version), e || c) {
            if (c) {
        ...
        var x = this,
            y = y || this.indexedDB || this.webkitIndexedDB || this.mozIndexedDB || this.OIndexedDB || this.msIndexedDB;
        if (y) {
          var z,
              A,
      ...
      b.__esModule = !0, function() {
        ...
        function f(a) {
          ...
          for (b = 0; b < c.length; b += 3)
            d += g[c[b] >> 2], d += g[(3 & c[b]) << 4 | c[b + 1] >> 4], d += g[(15 & c[b + 1]) << 2 | c[b + 2] >> 6], d += g[63 & c[b + 2]];
      ...
      b.__esModule = !0, function() {
        function a(a) {
          ...
          var f = new Promise(function(c, e) {
            try {
              d.db = n(d.name, String(d.version), d.description, d.size);
            } catch (f) {
