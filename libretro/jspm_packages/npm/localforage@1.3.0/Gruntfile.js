  ...
  module.exports = exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      concat: {
        ...
        localforage: {
          files: {
            'dist/localforage.js': ['bower_components/es6-promise/promise.js', 'dist/localforage.nopromises.js'],
      ...
      mocha: {unit: {options: {urls: ['http://localhost:9999/test/test.component.html', 'http://localhost:9999/test/test.nodriver.html', 'http://localhost:9999/test/test.main.html', 'http://localhost:9999/test/test.min.html', 'http://localhost:9999/test/test.require.html', 'http://localhost:9999/test/test.require.unbundled.html', 'http://localhost:9999/test/test.browserify.html', 'http://localhost:9999/test/test.webpack.html', 'http://localhost:9999/test/test.callwhenready.html', 'http://localhost:9999/test/test.customdriver.html']}}},
      ...
      watch: {
        ...
        'mocha:unit': {
          ...
          tasks: ['jshint', 'jscs', 'shell:component', 'browserify:package_bundling_test', 'webpack:package_bundling_test', 'mocha:unit']
        }
      },
      webpack: {
    ...
    var testTasks = ['build', 'babel', 'jshint', 'jscs', 'shell:component', 'browserify:package_bundling_test', 'webpack:package_bundling_test', 'connect:test', 'mocha'];
